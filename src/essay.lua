...
if ECconfig.wave1 then
    SMODS.Joker { -- Forklift
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.card_limit}
            }
        end,
    ...
    SMODS.Joker { -- Double Rainbow
        ...
        calculate = function(self, card, context)
            if context.repetition and context.cardarea == G.play and
                SMODS.get_enhancements(context.other_card)["m_lucky"] == true then
                return {
    ...
    SMODS.Joker { -- Starfruit
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.uses, G.GAME.probabilities.normal, card.ability.extra.odds}
            }
        end,
    ...
    SMODS.Joker { -- Eclipse
        ...
        loc_vars = function(self, info_queue, card)
            ...
            return {
                vars = {((levels - hands) * card.ability.extra.chip_mod), card.ability.extra.chip_mod}
            }
        end,
    ...
    SMODS.Joker { -- Rubber Ducky
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.chips, card.ability.extra.suck}
            }
        end,
        ...
        calculate = function(self, card, context)
            if context.cardarea == G.play and context.individual and not context.blueprint then
                ...
                if context.other_card.ability.perma_bonus > card.ability.extra.min_bonus then
                    ...
                    context.other_card.ability.perma_bonus = math.max(
                        (context.other_card.ability.perma_bonus - card.ability.extra.suck),
                        (card.ability.extra.min_bonus))
    ...
    SMODS.Joker { -- Pocket Aces
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.money, card.ability.extra.m_gain}
            }
        end,
        ...
        calculate = function(self, card, context)
            if context.individual and context.cardarea == G.play and context.other_card:get_id() == 14 and
    ...
    SMODS.Joker { -- Warlock             
        ...
        loc_vars = function(self, info_queue, card)
            info_queue[#info_queue + 1] = G.P_CENTERS.m_lucky
            return {
                vars = {G.GAME.probabilities.normal, card.ability.extra.odds, card.ability.extra.destructo}
            }
        end,
        ...
        calculate = function(self, card, context)
            ...
            elseif context.cardarea == G.play and context.individual and
                SMODS.get_enhancements(context.other_card)["m_lucky"] == true then
    ...
    SMODS.Joker { -- Purple Joker
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.mulchs}
            }
        end,
        ...
        calculate = function(self, card, context)
            ...
            if context.end_of_round and not context.blueprint and not context.repetition and not context.individual then
                if (G.GAME.current_round.hands_left + G.GAME.current_round.discards_left > 0) then
                    card.ability.extra.mulchs = card.ability.extra.mulchs + G.GAME.current_round.hands_left +
            ...
            elseif context.cardarea == G.jokers and context.joker_main and context.scoring_hand and
                card.ability.extra.mulchs > 1 then
                return {
    ...
    SMODS.Joker { -- Compost
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.mult, card.ability.extra.mod, card.ability.extra.fill}
            }
        end,
    ...
    SMODS.Joker { -- Candy Necklace
        ...
        loc_vars = function(self, info_queue, card)
            ...
            return {
                vars = {card.ability.extra.candies, card.ability.extra.flavours}
            }
        end,
    ...
    SMODS.Joker { -- Turtle
        ...
        calculate = function(self, card, context)
            ...
            elseif context.end_of_round and not context.repetition and not context.individual and not G.GAME.blind.boss and
                not context.blueprint then
    ...
    SMODS.Joker { -- Clown College
        ...
        calculate = function(self, card, context)
            if context.end_of_round and not context.repetition and not context.individual and G.GAME.blind.boss and
                not context.blueprint then
    ...
    SMODS.Joker { -- Handbook
        ...
        calculate = function(self, card, context)
            ...
            elseif context.cardarea == G.jokers and G.GAME.hands[context.scoring_name] and
                G.GAME.hands[context.scoring_name].played_this_round == 1 and not context.blueprint and context.before then
    ...
    SMODS.Joker { -- Ten Gallon
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.Xmult, card.ability.extra.dollars,
                        to_big(1) + to_big(card.ability.extra.Xmult) *
                    math.floor(
                        (G.GAME.dollars + (G.GAME.dollar_buffer or to_big(0))) / to_big(card.ability.extra.dollars))}
            }
        end,

        calculate = function(self, card, context)
            if context.cardarea == G.jokers and context.joker_main then
                local xmult = (to_big(card.ability.extra.Xmult) *
                                  math.floor(
                        (G.GAME.dollars + (G.GAME.dollar_buffer or to_big(0))) / to_big(card.ability.extra.dollars)))
...
if ECconfig.wave2 then
    SMODS.Joker { -- Monte Haul
        ...
        loc_vars = function(self, info_queue, card)
            ...
            return {
                vars = {card.ability.extra.monty_rounds}
            }
        end,
    ...
    SMODS.Joker { -- Espresso
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.money, card.ability.extra.m_loss}
            }
        end,
    ...
    SMODS.Joker { -- Hold Your Breath
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.chips, card.ability.extra.chip_mod, card.ability.extra.chip_limit}
            }
        end,
    ...
    SMODS.Joker { -- Ouppy Bog
        ...
        calculate = function(self, card, context)
            ...
            elseif context.setting_blind and not card.getting_sliced and not context.blueprint and
                G.consumeables.cards[1] then
    ...
    SMODS.Joker { -- Prideful Joker
        ...
        calculate = function(self, card, context)
            if context.cardarea == G.play and context.individual and
                SMODS.get_enhancements(context.other_card)["m_wild"] == true then
                return {
    ...
    SMODS.Joker { -- Tuxedo
        ...
        calculate = function(self, card, context)
            ...
            if context.cardarea == G.play and context.repetition and
                context.other_card:is_suit(G.GAME.current_round.tuxedo_card.suit) then
                return {
                    message = localize('k_again_ex'),
    ...
    SMODS.Joker { -- Farmer
        ...
        calculate = function(self, card, context)
            if context.cardarea == G.hand and context.end_of_round and context.individual and not context.repetition and
                context.other_card:is_suit(G.GAME.current_round.farmer_card.suit) then
                delay(0.15)
                return {
                    dollars = 2,
    ...
    SMODS.Joker { -- Accretion Disk
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.used, card.ability.extra.needs}
            }
        end,
            ...
            elseif context.before and not context.blueprint then
                ...
                if not card.ability.extra.fished then
                    for i = 1, #context.scoring_hand do
                        if context.scoring_hand[i].base.value == G.GAME.current_round.fish_rank.rank and
...
if ECconfig.wave3 then
    SMODS.Joker { -- Plushie
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.chips,
                        (G.jokers and G.jokers.cards and #G.jokers.cards or 0) * card.ability.extra.chips}
            }
        end,
            ...
            if context.cardarea == G.jokers and context.joker_main then
                return {
                    message = localize {
                        type = 'variable',
                        key = 'a_chips',
                        vars = {(G.jokers and G.jokers.cards and #G.jokers.cards or 0) * card.ability.extra.chips}
                    },
    ...
    SMODS.Joker { -- Pyromancer
        ...
        calculate = function(self, card, context)
            if context.cardarea == G.jokers and context.joker_main and G.GAME.current_round.hands_left <=
                G.GAME.current_round.discards_left then
                return {
                    message = localize {
                        type = 'variable',
                        key = 'a_mult',
    ...
    SMODS.Joker { -- Bobby
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.hands, card.ability.extra.discards}
            }
        end,
                ...
                G.E_MANAGER:add_event(Event({
                    func = function()
                        ...
                        elseif G.GAME.current_round.hands_left == 2 then
                            ...
                            card_eval_status_text(context.blueprint_card or card, 'extra', nil, nil, nil, {
                                message = "+" .. tostring(card.ability.extra.discards / 2) .. " " ..
                                    localize('k_hud_discards'),
                                colour = G.C.RED
                            })
                        ...
                        G.E_MANAGER:add_event(Event({
                            func = (function()
                                G.E_MANAGER:add_event(Event({
                                    func = function()
                                        local card =
                                            create_card('Tarot', G.consumeables, nil, nil, nil, nil, nil, 'yin')
                                        card:add_to_deck()
                                        G.consumeables:emplace(card)
                                        G.GAME.consumeable_buffer = 0
                                        return true
    ...
    SMODS.Joker { -- Chain Lightning
        ...
        calculate = function(self, card, context)
            ...
            elseif context.cardarea == G.play and context.individual and context.other_card.config.center.key ==
                "m_mult" then
    ...
    SMODS.Joker { -- Bad Apple
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.chips, card.ability.extra.odds, G.GAME.probabilities.normal}
            }
        end,
            ...
            elseif context.end_of_round and not context.repetition and not context.individual and not context.blueprint then
                if pseudorandom('apple') < G.GAME.probabilities.normal / card.ability.extra.odds then
                    ...
                    local joker_to_destroy = #destructable_jokers > 0 and
                                                 pseudorandom_element(destructable_jokers, pseudoseed('apple')) or nil
    ...
    SMODS.Joker { -- Passport
        ...
        loc_vars = function(self, info_queue, card)
            return {
                vars = {card.ability.extra.stamps}
            }
        end,

        calculate = function(self, card, context)
            if card.ability.extra.stamps > 0 and context.discard and G.GAME.current_round.discards_left == 2 and
                not context.blueprint then
                local eval = function()
                    return G.GAME.current_round.discards_left > 0 and card.ability.extra.stamps > 0
                end
                juice_card_until(card, eval, true)
            end

            if card.ability.extra.stamps > 0 and context.discard and G.GAME.current_round.discards_left == 1 and
                not context.blueprint and #context.full_hand == 1 then
                local seal_type = SMODS.poll_seal({
                    guaranteed = true
                })
            ...
            elseif context.end_of_round and not context.repetition and not context.individual and G.GAME.blind.boss and
                not context.blueprint then
...
SMODS.Back { -- Bazaar Deck
    ...
    loc_txt = {
        name = 'Bazaar Deck',
        text = {"Start run with", "{C:money,T:v_clearance_sale}#1#{},", "{C:attention,T:v_magic_trick}#2#{},",
    ...
    discovered = true,
    config = {
        vouchers = {"v_clearance_sale", "v_magic_trick", "v_hone"}
    },
...
SMODS.Back { -- Archeology Deck
    ...
    loc_txt = {
        name = 'Archeology Deck',
        text = {"Start in {C:attention}Ante 0", "{C:attention}-1{} hand size"}
    },
    order = 17,
    unlocked = true,
    discovered = true,
...
SMODS.Back { -- Echo Deck
    ...
    loc_txt = {
        name = 'Echo Deck',
        text = {"{C:attention}Retrigger{} all playing cards", "{C:red}X1.2{} base Blind size",
...
local function reset_tuxedo_card()
    ...
    for k, suit in pairs(SMODS.Suits) do
        if k ~= G.GAME.current_round.tuxedo_card.suit and (type(suit.in_pool) ~= "function" or suit:in_pool({
            rank = ""
        })) then
...
local function reset_farmer_card()
    ...
    for k, suit in pairs(SMODS.Suits) do
        if k ~= G.GAME.current_round.farmer_card.suit and (type(suit.in_pool) ~= "function" or suit:in_pool({
            rank = ""
        })) then
...
local function reset_fish_rank()
    ...
    for k, rank in pairs(SMODS.Ranks) do
        if k ~= G.GAME.current_round.fish_rank.rank and (type(rank.in_pool) ~= "function" or rank:in_pool({
            suit = ""
        })) then
